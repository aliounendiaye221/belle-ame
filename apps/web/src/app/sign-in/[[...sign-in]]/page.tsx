...
export default function CustomSignInPage() {
  ...
  // Connexion par Email et Mot de Passe (Sans aucun numéro de téléphone)
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.status === "complete") {
        ...
        // Si une étape supplémentaire email est requise
  ...
  // Connexion en 1 Clic via Google (Sans numéro de téléphone)
      ...
      >
        ...
        <div style={{ textAlign: "center", marginBottom: "2rem" }}>
          ...
          <p style={{ color: "#a0aba4", fontSize: "0.85rem", margin: 0, lineHeight: 1.4 }}>
            Accédez à votre espace « À Chacun Une Belle Âme »
          </p>
        </div>
        ...
        <div style={{ marginTop: "2rem", textAlign: "center", borderTop: "1px solid rgba(212, 163, 115, 0.15)", paddingTop: "1.25rem" }}>
          <p style={{ color: "#a0aba4", fontSize: "0.85rem", margin: 0 }}>
            ...
            <Link href="/sign-up" style={{ color: "#f4c07c", fontWeight: "800", textDecoration: "none" }}>
